 ...
 */
public fun ByteArray.encodeToBase58String(): String {
...
public fun String.decodeBase58(): ByteArray {
  if (isEmpty()) {
    return ByteArray(0)
  }
 ...
 * @return the base58-encoded string
 */
public fun ByteArray.encodeToBase58WithChecksum(): String = ByteArray(size + CHECKSUM_SIZE).apply {
...
public fun String.decodeBase58WithChecksum(): ByteArray {
